...
namespace SmartStepsServer.Migrations
{
    ...
    [Migration("20260723022234_AddTaskAndRewardTables")]
    partial class AddTaskAndRewardTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.AppFeedback", b =>
                {
                    ...
                    b.ToTable("AppFeedback", null, t =>
                        {
                            t.HasCheckConstraint("CK_AppFeedback_Category", "\"Category\" IN ('Bug', 'Suggestion', 'InappropriateContent')");
                            ...
                            t.HasCheckConstraint("CK_AppFeedback_Status", "\"Status\" IN ('New', 'Processing', 'Resolved')");
                        });
                });

            modelBuilder.Entity("SmartStepsServer.Data.Models.ChildLinkCode", b =>
                {
                    b.Property<int>("ChildLinkCodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ChildLinkCodeId"));
                    ...
                    b.ToTable("ChildLinkCode");
                });

            modelBuilder.Entity("SmartStepsServer.Data.Models.ChildTask", b =>
                {
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.LessonAssignment", b =>
                {
                    ...
                    b.ToTable("LessonAssignment", null, t =>
                        {
                            t.HasCheckConstraint("CK_LessonAssignment_Status", "\"Status\" IN ('Assigned', 'InProgress', 'Completed', 'Cancelled')");
                        });
                });
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.ParentActivityConfirmation", b =>
                {
                    ...
                    b.HasIndex("ParentId", "ChildId", "SituationId");

                    b.ToTable("ParentActivityConfirmation");
                });
                    ...
                    b.ToTable("PremiumPayment", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_PremiumPayment_Status", "\"Status\" IN ('Pending', 'Paid', 'Cancelled', 'Expired', 'Failed', 'Refunded')");
                        });
                });
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.RewardItem", b =>
                {
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.RewardRedemption", b =>
                {
                    b.Property<int>("RedemptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.TaskProgress", b =>
                {
                    b.Property<int>("TaskProgressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("TaskProgressId"));
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.ChildLinkCode", b =>
                {
                    ...
                    b.HasOne("SmartStepsServer.Data.Models.User", "UsedByParent")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.RewardRedemption", b =>
                {
                    ...
                    b.HasOne("SmartStepsServer.Data.Models.RewardItem", "Reward")
            ...
            modelBuilder.Entity("SmartStepsServer.Data.Models.TaskProgress", b =>
                {
                    ...
                    b.HasOne("SmartStepsServer.Data.Models.ChildTask", "Task")
